  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${inter.className} antialiased`}>
        ...
        {/* Custom Glass Social Media Component */}
        <div className="glass-social-container">
          <div className="glass-card">
            <a href="https://twitter.com/nitronapp" target="_blank" rel="noopener noreferrer" className="social-link twitter">
            ...
            <a href="https://linkedin.com/company/nitronapp" target="_blank" rel="noopener noreferrer" className="social-link linkedin">
              <div className="icon-wrapper">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://instagram.com/nitronapp" target="_blank" rel="noopener noreferrer" className="social-link instagram">
              <div className="icon-wrapper">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/nitronapp" target="_blank" rel="noopener noreferrer" className="social-link github">
              <div className="icon-wrapper">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
