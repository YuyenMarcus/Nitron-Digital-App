...
const coreFeatures = [
  {
    title: "Get Paid Faster. Seriously.",
    subtitle: "Automated Invoicing & Payments",
    description: "Create professional invoices in minutes and accept credit card payments via Stripe. Get real-time notifications when a client pays, so you're always in the loop.",
    icon: (
